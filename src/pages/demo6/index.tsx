...
const listOurMainServices = [
  {
    ...
    buttonClassName: "border-[#76609E] text-[#76609E] hover:text-[#000]",
  },
  {
...
const listBlogItem = [
  {
    ...
    iconColor: "#76609E",
    buttonClassName: "text-[#76609E] border-[#76609E] hover:text-[#000]",
  },
  {
    id: 2,
    title: "Drive Traffic to Website",
    ...
    <>
      <main className="text-[#666] text-[15px] leading-[1.8] font-[300] tracking-[0.5px]">
        ...
        <AboutBanner
          ...
          buttonClassName="bg-[#fff] hover:text-[#76609E]"
        ...
        <CounterSection
          ...
          titleColor="text-[#00B0FE]"
        />
        <section id="service" className="relative pb-[70px] pt-[100px] bg-[url(/images/demo6/demo6-our-main-services.svg)] bg-cover">
          <div className="relative mx-auto xl:w-[1170px]">
            <HeadTitle
        ...
        <Footer
          ...
          linkClassName="after:bg-[#76609E] text-[#000] hover:text-[#5d5d5d]"
